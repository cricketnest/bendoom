...
6. Monsters, weapons, damage, the status bar and intermission. Both E1M1 populations see, hear, chase, attack, take damage, die, drop items and fight each other; the player can use the maps' fist, chainsaw, pistol and shotgun. Damage, death, rebirth, messages, palette flashes, the face and the intermission follow vanilla. Automated combat, render, route, proof and performance checks are recorded under `.scratch/milestone-6-combat/`; the maintainer played both maps to the intermission. The long fight on the shareware map and the zombiemen's and the face's last cases are still to be compared with Chocolate Doom.
7. Sound effects. Doors, the lift, switches, pickups, weapons, monsters, the player and the intermission sound from the WAD's own lumps, expanded and mixed over the music on vanilla's eight moving channels. The film carries the same mix.
