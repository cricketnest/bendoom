...
6. Monsters, weapons, damage, the status bar and intermission. Both E1M1 populations see, hear, chase, attack, take damage, die, drop items and fight each other; the player can use the maps' fist, chainsaw, pistol and shotgun. Damage, death, rebirth, messages, palette flashes, the face and the intermission follow vanilla. Automated combat, render, route, proof and performance checks are recorded under `.scratch/milestone-6-combat/`; final playthrough acceptance remains.
