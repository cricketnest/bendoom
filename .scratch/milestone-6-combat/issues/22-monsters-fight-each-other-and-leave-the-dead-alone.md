...
- [x] Every oracle case of tickets 15 to 21 that was limited by a missing behaviour is now run at full length
...
- The integrated rest, combat, palette and moving routes all compare at zero pixels. The complete 2060-tic Freedoom exit replay also agrees with Chocolate Doom in player position, angle, health, armour, kills and every random draw through completion.
