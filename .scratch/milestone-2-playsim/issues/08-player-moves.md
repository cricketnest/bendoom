...
The test's every line was cross-checked against `tools/refsim.py`, a Python model of the same Doom code written independently first, which agreed on all fifteen lines on both WADs.
