...
Its other ammo and weapon records are multiplayer-only or for other skills; the shotguns (183, 256) and the backpack (288) are for the easy ones. So the backpack and shotgun cases spawn records 288 and 256 through `Thing.spawn.mobj` after the level's things. Each case prints the tic before contact and the contact tic:
...
| chainsaw before, tic 33 | 3158 2176 180 | `20,0,0,0,0 1,0,0,-16,0 12,0,-24,0,0` | 10 |
| chainsaw after, tic 34 | 3158 2176 180 | `20,0,0,0,0 1,0,0,-16,0 13,0,-24,0,0` | 0 |

The rocket, 24 units tall, is taken on tic 33, about 46 ahead and 19 left: screen columns 77 to 111, clear of the pistol mask. A pickup of rockets from none switches no weapon from the pistol, so this is a fidelity case. The chainsaw's contact tic is comparable too: vanilla sets its pending weapon then, but the pistol only starts down on the next tic. Its before frame's 10 pixels are at x 76 and 77 near the horizon and one at (233, 121), away from the sprite. They look like a renderer edge in that view, not pickups; they are not in the render test. The refused frames hold every weapon and every ammo type at its cap. Vanilla's demo cannot reach that inventory, so they are not compared. Against their taken twins they differ in exactly the sprite: 762 pixels of the rocket (columns 77 to 111, rows 136 to 167) and 5092 of the chainsaw. Rerun on this branch, ticket 06's table is unchanged, key frames 0 and 0, and every older render hash is unchanged.

Trade-offs:

- **Spawned records.** The backpack and shotgun cases append their record to the population, where lump order would put them among the others. Order only matters for two things touched in one check, which no case does.
- **Not represented.** The pending weapon, P_GiveAmmo's weapon switch, the dropped half-clip, messages and sounds, as the spec says.
