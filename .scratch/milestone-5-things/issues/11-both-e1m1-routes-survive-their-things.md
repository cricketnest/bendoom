...
**The play-through.** The maintainer played both maps to the exit in the window on 2026-09-19, on the ticket 12 build (`f31ecf6`): Freedoom along this route, the blue key and both blue doors included, in 52 seconds, then the shareware map past the barrel to its exit switch.
