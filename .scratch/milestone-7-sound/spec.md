...
Bendoom plays E1M1's sounds over its song. Doors, lifts, switches, pickups, weapons, monsters, the player and the intermission use the WAD's own lumps. In vanilla, sound is also information. A sight growl tells the player that a monster has noticed them, a door heard behind them tells them someone came through it, and the stereo position says from where.
...
- A sound starts at the first frame of the next write after its tic. The queue holds 2304 frames, 52.2 ms, against Chocolate Doom's 1024 frames and 23.2 ms. The fight bench found 1024 routinely dry, 1536 intermittently dry and 2048 dry on its cold run; 2304 is the lowest measured level that also held from a cold start on the development machine.
